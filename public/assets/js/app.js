...
(function() {
    ...
    function initMobileSidebar() {
        ...
        if (!toggleBtn) {
            ...
            if (navbar) {
                ...
                toggleBtn.className = 'btn btn-sm btn-outline-primary sidebar-toggle d-md-none me-2';
                toggleBtn.innerHTML = '<i class="bi bi-list"></i>';
                toggleBtn.setAttribute('aria-label', 'Toggle sidebar');
                
                const navbarContainer = navbar.querySelector('.container, .container-fluid');
                if (navbarContainer) {
                    const firstChild = navbarContainer.querySelector('.d-flex, .navbar-brand');
                    if (firstChild) {
    ...
    function initScrollEffects() {
        const header = document.querySelector('header.navbar-header, header.bg-white');
        if (!header) return;
